...
from models.model2_enhanced_2 import FashionCaptionModelEnhanced, load_vocab
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss - early_stopping_min_delta:
            ...
            checkpoint_path = checkpoint_dir / "model2_enhanced_2_checkpoint.pt"
            torch.save({
    ...
    print(f"\n最佳模型:")
    print(f"  - 最佳验证损失: {best_val_loss:.4f}")
    print(f"  - 模型已保存到: models/checkpoints/model2_enhanced_2_checkpoint.pt")
